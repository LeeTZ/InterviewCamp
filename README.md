...
* Given a string, find the first character that appears only once in this string.[Tolution](https://github.com/LeeTZ/InterviewCamp/blob/master/src/first_non_repeat_char.py) Source: [310841](http://www.1point3acres.com/bbs/forum.php?mod=viewthread&tid=310841)
* Given a set of intervals and a point, find all intervals that contain this point. ([Interval Tree](https://cs.stackexchange.com/questions/51550/data-structure-for-set-of-intervals-query-for-all-intervals-contains-given-poi/51551)); [Tolution](https://github.com/LeeTZ/InterviewCamp/blob/master/src/find_interval_cover_the_point.py) Source: [302897](http://www.1point3acres.com/bbs/forum.php?mod=viewthread&tid=302897)
